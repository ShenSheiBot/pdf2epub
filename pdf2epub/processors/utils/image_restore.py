...
def _nearest_mapped_pos(original_noimg_pos: int, blocks: List[difflib.Match]) -> int:
    """
...
def _local_exact_probe(polished: str, before_ctx: str, after_ctx: str) -> Optional[int]:
    """
...
def restore_lost_images_fast(
    ...
    for img_md in lost:
        ...
        local_insert = _local_exact_probe(
            polished_content[left:right], before_ctx, after_ctx
        )
